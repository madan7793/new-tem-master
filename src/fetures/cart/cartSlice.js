...
export const {addToCart, increaseProductCount, decreaseProductCount, removeProductFromCart, checkAll, removeChecked, changeCheckStatus, moveToWishlist, clearCart, removeOrderPlacedItems, addToWishlist, removeFromWishlist} = cartSlice.actions
